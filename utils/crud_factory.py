...
def crud_factory(bp: Blueprint, model, endpoint: str, required_fields=None, user_owned=False, allow_cross_user_create=False, exclude_methods=None):
    """
    ...
    # --- PATCH ---
    if "UPDATE" not in exclude_methods:
